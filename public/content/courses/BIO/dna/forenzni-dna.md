---
title: Forenzní DNA — případy a metody
---
...
<svg viewBox="0 0 540 180" font-family="ui-sans-serif, system-ui" font-size="11">
  ...
  <g fill="var(--bg-card)" stroke="var(--accent)" stroke-width="1.2">
    <rect x="10" y="60" width="90" height="40" rx="4"/>
    <rect x="110" y="60" width="100" height="40" rx="4"/>
    <rect x="220" y="60" width="100" height="40" rx="4"/>
    <rect x="330" y="60" width="100" height="40" rx="4"/>
    <rect x="440" y="60" width="90" height="40" rx="4"/>
  </g>
  <g fill="var(--text)" text-anchor="middle" font-size="10">
    <text x="55" y="84">crime DNA</text>
    <text x="55" y="96" font-size="9" fill="var(--text-muted)">unknown</text>
    <text x="160" y="84">upload to DB</text>
    <text x="160" y="96" font-size="9" fill="var(--text-muted)">GEDmatch</text>
    <text x="270" y="84">find matches</text>
    <text x="270" y="96" font-size="9" fill="var(--text-muted)">distant cousins</text>
    <text x="380" y="84">family tree</text>
    <text x="380" y="96" font-size="9" fill="var(--text-muted)">build genealogy</text>
    <text x="485" y="84">suspect</text>
    <text x="485" y="96" font-size="9" fill="var(--text-muted)">identify</text>
  </g>
  <g stroke="var(--accent)" stroke-width="1.2" fill="none" marker-end="url(#aIGG)">
    <path d="M100,80 L108,80"/>
    <path d="M210,80 L218,80"/>
    <path d="M320,80 L328,80"/>
    <path d="M430,80 L438,80"/>
  </g>
</svg>
:::
...
*Zdroj: BIO přednášky 2025/26, BIO 7 — DNA a její využití v biometrii (Drahanský, Doležel, Sakin). Externí reference: Wambaugh, J.: *The Blooding* (1989) — Pitchfork case; Innocence Project — [innocenceproject.org](https://innocenceproject.org/); Greytak, E. M. et al.: *Genetic genealogy for cold case and active investigations* (Forensic Science International 2019); FBI: *Investigative Genetic Genealogy* policies.*
