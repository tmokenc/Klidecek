...
Optimalizace zápisu — při **eventual consistency** se update na duplikovaná data nepropaguje okamžitě, ale asynchronně — typicky přes background job nebo change stream.
