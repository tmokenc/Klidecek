...
::: svg "Alpha-beta prořezávání: pokud beta ≤ alpha, můžeme zbytek stromu odříznout."
<svg viewBox="0 0 540 230" font-family="ui-sans-serif, system-ui" font-size="11">
  <g fill="var(--bg-card)" stroke="var(--accent)" stroke-width="1.3">
    <rect x="240" y="20" width="60" height="30" rx="4"/>
  ...
  <g fill="var(--text-muted)" font-size="9.5" text-anchor="middle">
    <text x="380" y="220">Po objevení listu 2 v prostřední větvi víme, že MIN volí ≤ 2,</text>
    <text x="380" y="232">což je horší než ž MAXovo dosavadní 3 — zbytek lze odříznout.</text>
  </g>
</svg>
:::
